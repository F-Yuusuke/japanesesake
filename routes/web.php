...
// 酒蔵新規登録・ログイン用
Route::group(['prefix' => 'sakagura', 'middleware' => 'guest:owner'], function() {
    // Route::get('/', function () {
...
// 酒蔵ログアウト用
Route::group(['prefix' => 'sakagura', 'middleware' => 'auth:owner'], function(){

    Route::get('mypage', 'SakaguraController@mypage')->name('sakagura.mypage');
